...
@app.get("/insert-user")
def save_user():
    User(username="andika",email="andikawiratana@gmail.com",hashed_password="$2a$12$CgZlwQvsQfj.py/vZ9apM.VWdXcCIvG1Shnbz6pBSZWJj3G3G3iD.", disabled=False).save()
    return {"Hello": get_user("andika")}
